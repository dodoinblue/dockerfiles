...
$servers->setValue('server','name','Super Star LDAP Server');
...
$servers->setValue('server','base',array('dc=supersuperstar,dc=com'));
...
/* The DN of the user for phpLDAPadmin to bind with. For anonymous binds or
   ...
   binds. */
$servers->setValue('login','bind_id','cn=admin,dc=supersuperstar,dc=com');
